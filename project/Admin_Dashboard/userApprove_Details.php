...
if (isset($_SESSION['useremail'])) {
    ...
    $user = $admin->viewUserApprovalDetails($nic);
}
...
if($user){
    ...
    <div class="user-details-container">
        ...
        <table class="user-details">
                ...
                <tr>
                    <td><b>4) Status : </b></td>
                    <td><?php if($admin->inBannedList(htmlspecialchars($user['nic']))){
                        echo "<font style='color:red'>Blacklisted</font>";
                    }else{
                        echo "No Issues";
                    }; ?></td>
                </tr>
        ...
        <div class="button-group">
            ...
            <button class="btn btn-sm btn-primary UD" id="approveUserBtn" onclick="popupApproveUser(<?php echo $rowNumber ?>)">Approve</button>
